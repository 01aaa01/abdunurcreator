...
const NOOR_TRANSLATIONS = {
  uz: {
    ...
    'auth.viaEmail': 'Email orqali kirish',
    'auth.back': 'Orqaga',
    'auth.emailLabel': 'Email',
    'auth.fullName': "To'liq ism",
    'auth.usernameLabel': 'Username',
    'auth.emailOptional': 'Email (ixtiyoriy)',
    'auth.passwordMin': 'Parol (kamida 6 belgi)',
    'auth.confirmPassword': 'Parolni tasdiqlang',
    'auth.continue': 'Davom etish',
    'auth.chooseVerify': 'Tasdiqlash usulini tanlang:',
    'auth.verifyTelegram': 'Telegram orqali tasdiqlash',
    'auth.verifyEmail': 'Email orqali tasdiqlash',
    'auth.tgVerifyHint': "Botga o'ting va <b>/start</b> yuboring, so'ng tasdiqlash tugmasini bosing.",
    'auth.verifyInTelegram': "Telegram'da tasdiqlash",
    'auth.iVerified': 'Tasdiqladim, davom etish',
    ...
    'chat.groupImg': 'Rasm yaratish',
    'chat.groupVideo': 'Video yaratish',
    'chat.groupAudio': 'Ovoz yaratish',
    'chat.noteNoorImg': "Noor AI IMG — tepadan AI va o'lchamni tanlang, pastga nima chizish kerakligini yozing va yuboring.",
    'chat.noteNoorAudio': "Noor Audio — tepadan ovozni tanlang, pastga gapirtirmoqchi bo'lgan matningizni yozing va yuboring.",
    'noorAudio.voice': 'Ovoz',
    'noorAudio.voiceStandard': 'Standart',
    'noorAudio.voiceMale': 'Erkak',
    'noorAudio.voiceFemale': 'Ayol',
    'noorAudio.placeholder': 'Nima deb gapirtirish kerakligini yozing...',
    ...
    'attach.createImage': 'Rasm yaratish',
    'createImg.ai': 'AI',
    'createImg.size': "O'lcham",
    'createImg.square': 'Kvadrat (1:1)',
    'createImg.portrait': 'Portret (3:4)',
    'createImg.landscape': 'Landshaft (16:9)',
    'createImg.download': 'Yuklab olish',
    'createImg.share': 'Ulashish',
    'createImg.copy': 'Nusxalash',
    'createImg.copied': 'Havola nusxalandi!',
    'createImg.placeholder': 'Nima chizish kerakligini yozing...',
    ...
    'profile.apiKeyLabel': 'Noor AI API kaliti (dasturchilar uchun, bepul)',
  ...
  ru: {
    ...
    'auth.viaEmail': 'Войти через email',
    'auth.back': 'Назад',
    'auth.emailLabel': 'Email',
    ...
    'auth.chooseVerify': 'Выберите способ подтверждения:',
    'auth.verifyTelegram': 'Подтвердить через Telegram',
    'auth.verifyEmail': 'Подтвердить через email',
    'auth.tgVerifyHint': 'Перейдите к боту и отправьте <b>/start</b>, затем нажмите кнопку подтверждения.',
    'auth.verifyInTelegram': 'Подтвердить в Telegram',
    'auth.iVerified': 'Я подтвердил, продолжить',
    ...
    'chat.groupImg': 'Создание изображений',
    'chat.groupVideo': 'Создание видео',
    'chat.groupAudio': 'Создание аудио',
    'chat.noteNoorImg': 'Noor AI IMG — выберите AI и размер сверху, напишите что нарисовать снизу и отправьте.',
    'chat.noteNoorAudio': 'Noor Audio — выберите голос сверху, напишите текст снизу и отправьте.',
    'noorAudio.voice': 'Голос',
    'noorAudio.voiceStandard': 'Стандартный',
    'noorAudio.voiceMale': 'Мужской',
    'noorAudio.voiceFemale': 'Женский',
    'noorAudio.placeholder': 'Напишите текст для озвучки...',
    ...
    'attach.createImage': 'Создать изображение',
    'createImg.ai': 'ИИ',
    'createImg.size': 'Размер',
    'createImg.square': 'Квадрат (1:1)',
    'createImg.portrait': 'Портрет (3:4)',
    'createImg.landscape': 'Пейзаж (16:9)',
    'createImg.download': 'Скачать',
    'createImg.share': 'Поделиться',
    'createImg.copy': 'Копировать',
    'createImg.copied': 'Ссылка скопирована!',
    'createImg.placeholder': 'Напишите, что нарисовать...',
    ...
    'profile.apiKeyLabel': 'API-ключ Noor AI (для разработчиков, бесплатно)',
  ...
  en: {
    ...
    'auth.viaEmail': 'Log in with email',
    'auth.back': 'Back',
    'auth.emailLabel': 'Email',
    ...
    'auth.chooseVerify': 'Choose a verification method:',
    'auth.verifyTelegram': 'Verify via Telegram',
    'auth.verifyEmail': 'Verify via email',
    'auth.tgVerifyHint': 'Open the bot and send <b>/start</b>, then press the confirm button.',
    'auth.verifyInTelegram': 'Verify in Telegram',
    'auth.iVerified': 'I verified, continue',
    ...
    'chat.groupImg': 'Image generation',
    'chat.groupVideo': 'Video generation',
    'chat.groupAudio': 'Audio generation',
    'chat.noteNoorImg': 'Noor AI IMG — pick an AI and size above, write what to draw below, and send.',
    'chat.noteNoorAudio': 'Noor Audio — pick a voice above, write the text to speak below, and send.',
    'noorAudio.voice': 'Voice',
    'noorAudio.voiceStandard': 'Standard',
    'noorAudio.voiceMale': 'Male',
    'noorAudio.voiceFemale': 'Female',
    'noorAudio.placeholder': 'Write the text to speak...',
    'noorAudio.play': 'Play',
    ...
    'attach.createImage': 'Create image',
    'createImg.ai': 'AI',
    'createImg.size': 'Size',
    'createImg.square': 'Square (1:1)',
    'createImg.portrait': 'Portrait (3:4)',
    'createImg.landscape': 'Landscape (16:9)',
    'createImg.download': 'Download',
    'createImg.share': 'Share',
    'createImg.copy': 'Copy',
    'createImg.copied': 'Link copied!',
    'createImg.placeholder': 'Write what to draw...',
    ...
    'profile.save': 'Save',
    'profile.apiKeyLabel': 'Noor AI API key (for developers, free)',
