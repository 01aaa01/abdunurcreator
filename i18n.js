...
const NOOR_TRANSLATIONS = {
  uz: {
    ...
    'chat.noteNoorImg': "Noor AI IMG 1.0 — tepadan o'lchamni tanlang, pastga nima chizish kerakligini yozing va yuboring.",
  ...
  ru: {
    ...
    'chat.noteNoorImg': 'Noor AI IMG 1.0 — выберите размер сверху, напишите что нарисовать снизу и отправьте.',
  ...
  en: {
    ...
    'chat.noteNoorImg': 'Noor AI IMG 1.0 — pick a size above, write what to draw below, and send.',
